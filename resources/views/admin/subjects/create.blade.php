...
@section('title', 'Add New Subject - EDUgate Admin')
...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center py-4">
        <div>
            ...
            <p class="text-muted mb-0">Create a new subject and assign a teacher</p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="class" name="class" value="{{ old('class') }}" required placeholder="e.g., Grade 10">
