...
<head>
    ...
    <title>@yield('title', 'Student Portal - EDUgate')</title>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('student.grades') ? 'active' : '' }}" href="{{ route('student.grades') }}">
                            <i class="fas fa-users me-1"></i>My Grade Level
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('student.files.*') ? 'active' : '' }}" href="{{ route('student.files.index') }}">
                            <i class="fas fa-file-alt me-1"></i>My Documents
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('student.enrollment.edit') ? 'active' : '' }}" href="{{ route('student.enrollment.edit') }}">
                            <i class="fas fa-user-edit me-1"></i>Edit Enrollment Info
                        </a>
                    </li>
                </ul>
                            ...
                            <li>
                                <h6 class="dropdown-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-bold">{{ auth()->user()->name ?: 'Student' }}</div>
                                            <small class="text-muted">{{ auth()->user()->email }}</small>
                                            @if(auth()->user()->student && auth()->user()->student->grade)
                                                <small class="text-muted d-block">{{ auth()->user()->student->grade }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </h6>
